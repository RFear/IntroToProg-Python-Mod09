...
class FileProcessor:
    ...
    def save_data_to_file(file_name: str, list_of_objects: list):
        """ Write data to a file from a list of object lstrows
    ...
    def read_data_from_file(file_name: str):
        """ Reads data from a file into a list of object lstrows

        :param file_name: (string) with name of file
        :return: (list) of object lstrows
        """
        list_of_rows = []
        try:
            file = open(file_name, "r")
            for line in file:
                line = line.strip() # added in this method
                row = line.split(",")
